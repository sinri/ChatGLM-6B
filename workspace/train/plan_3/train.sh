...
train_file=/mnt/e/sinri/ChatGLM-6B/workspace/train/plan_3/input/train.json
validation_file=/mnt/e/sinri/ChatGLM-6B/workspace/train/plan_3/input/train.json

# output/adgen-chatglm-6b-pt-$PRE_SEQ_LEN-$LR
output_dir=/mnt/e/sinri/ChatGLM-6B/workspace/train/plan_3/output
